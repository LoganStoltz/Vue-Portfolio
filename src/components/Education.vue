  ...
  export default defineComponent({
    ...
    setup() {
      const allCourses = [
        ...
        {id: 2, title: 'Data Structures', classNumber: 'CSCD300', description: 'This course covers fundamental abstract concepts of data structures as well as their implementation in a programming language. Topics include linked lists, stacks, queues, hashing, recursion, complexity analysis of algorithms, binary search trees and heaps. Programming projects with formal documentation are required.'},
        ...
        {id: 4, title: 'Web Application Development', classNumber: 'CSCD378', description: 'This course examines the fundamental principles and techniques associated with the development of multi-tier web applications. Topics include web standards, portability, and usability. Programming projects are required.'},
        {id: 5, title: 'Programming Principles I', classNumber: 'CSCD210', description: 'This course covers the concepts and practices of information representation, computer algorithms, hardware organization and computer program design and implementation. Students write, run, debug, analyze and evaluate computer programs. Topics include primitive data types, number systems, file I/O classes, control structures, method design and usage, array–sorting and searching algorithms. Programming projects are required.'},
        {id: 6, title: 'Programming Principles II', classNumber: 'CSCD211', description: 'This course continues coverage of concepts introduced in Programming Principles I. Topics include composition, recursion, data abstraction, polymorphism, inheritance, interfaces, inner classes, abstract classes, object cloning, array lists, linked lists, and exception handling. Programming projects are required.'},
        {id: 7, title: 'C++ Programming', classNumber: 'CSCD305', description: 'This course teaches the C++ programming language. Topics include basic syntax, pointers, memory management, classes, inheritance and polymorphism, exception handling, standard template library usage, namespaces, memory management, and graphical user interface (GUI) programming. Programming projects are required.'},
        {id: 8, title: 'C and Unix Programming', classNumber: 'CSCD240', description: 'This course includes program development tools of the UNIX operating system and syntax and programming techniques of the C language in that environment. UNIX topics include interactive shells, common text editors, utility programs, file system structure, libraries and operating system calls and system programming. C topics include data types, structures, pointers and pointer arithmetic, arrays, linked lists, and function design and use. Programming projects are required.'},
        ...
        {id: 12, title: 'Data Mining', classNumber: 'CSCD429', description: 'This course will provide an introduction to the main topics in data mining and knowledge discovery, including: data preparation for knowledge discovery, frequent pattern and association mining, classification and cluster analysis.'},
        {id: 13, title: 'Compilers', classNumber: 'CSCD420', description: 'This course explores Automata Theory, Regular Expressions, the Backus-Naur metalanguage for specifying programming language syntax, and Interpreter and Compiler Design. Programming projects are required'},
        ...
        {id: 16, title: 'Architecture and Organization', classNumber: 'CSCD260', description: 'This is an introductory course on microprocessor and microcontroller systems organization. It provides low-level programming principles for microcomputer based systems. The course emphasizes assembly and C language programming techniques and laboratory experiments in input/output programming, memory organization, interrupts and interfacing methods.'},
        ...
        {id: 18, title: 'Linear Algebra', classNumber: 'MATH231', description: 'This course covers the theory and practice of vector geometry in R2 and R3, systems of linear equations, matrix algebra, determinants, vector spaces, bases and dimension, linear transformations, eigenvalues and eigenvectors, rank and nullity and applications.'},
        {id: 19, title: 'Discrete Mathmatics', classNumber: 'MATH301', description: 'This course covers the theory and application of the mathematics most relevant to computer science. Foundation topics include logic, induction and recursion, methods of proof, set theory, relations and functions, and combinatorics. Implementation topics include graphs and matrices, including systems of linear equations, two dimensional rotation matrices and matrix representations of graphs, as well as selected topics in graph theory.'},
        {id: 20, title: 'Calculus I', classNumber: 'MATH161', description: 'This course introduces the concepts of mathematical limits, derivatives, definite and indefinite integrals, and of real-valued functions of a single real variable, with applications.'},
        {id: 21, title: 'Calculus II', classNumber: 'MATH162', description: 'This course presents techniques of integration and improper integrals, with applications, and introduces transcendental functions.'},
        {id: 22, title: 'Elementary Probability and Statistics', classNumber: 'MATH380', description: 'This course covers empirical and theoretical frequency distributions. Discrete and continuous random variables. The binomial random variable and the normal. Descriptive statistics including measures of location, spread and association. An introduction to inferential statistics including confidence intervals and hypothesis testing.'},

        // 🧠 Broader professional context
        {id: 23, title: 'Computing Ethics', classNumber: 'CSCD202', description: 'This course explores the uses of computing technologies from a socio-cultural and ethical perspective, including the impacts of information systems on individuals, organization, and society and future direction in which the forces of technology and computing are tending to move us.'}
      ];
